...
function generateKeywordSuggestions() {
  const keywordGroups = {
    primary: ['pre-baked pies', 'quality desserts', 'pie delivery', 'fresh baked pies', 'artisan pies'],
    secondary: ['pie fundraiser', 'wholesale pies', 'kosher desserts', 'all-butter crust', 'homemade pies'],
    longTail: [
